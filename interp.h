...
DECLARE_DO_FUN( do_battleprompt);
...
DECLARE_DO_FUN( do_debugger );
DECLARE_DO_FUN( do_debugmsg );
...
DECLARE_DO_FUN( do_musterthecorpsearmy);
...
DECLARE_DO_FUN( do_incubuspassion   );
DECLARE_DO_FUN( do_hauntthesoul );
DECLARE_DO_FUN( do_eyesofchaos  );
DECLARE_DO_FUN( do_silencethesanemind   );
DECLARE_DO_FUN( do_howlinglunacy);
...
DECLARE_DO_FUN( do_gxp	    );
DECLARE_DO_FUN( do_gqp      );
DECLARE_DO_FUN( do_xpmult   );
DECLARE_DO_FUN( do_qpmult   );
DECLARE_DO_FUN( do_cheater  );
DECLARE_DO_FUN( do_ipoint   );
DECLARE_DO_FUN( do_tag      );
DECLARE_DO_FUN( do_demeanor);
DECLARE_DO_FUN( do_resetkill);
