...
if ( (IS_AFFECTED(ch, AFF_SHIFT) && (!is_affected(gsn_vicissitude_horrid) && !is_affected(gsn_vicissitude_chiropteran)) ) || ch->changed == CHANGED_LUPUS || is_affected(ch,gsn_shadowform))
    {
