...
int	sect_lookup	args( (const char *name) );
int	tradition_lookup	args( (const char *name) );
int background_lookuup args ( (const char *name) );
int	rote_lookup	args( (const char *name) );
int	brew_lookup	args( (const char *name) );
